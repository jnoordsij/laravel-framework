...
class Composer
{
     ...
     * @return bool
     */
    public function requirePackages(array $packages, bool $dev = false, \Closure|\Symfony\Component\Console\Output\OutputInterface|null $output = null, $composerBinary = null)
    {
        $command = collect([
     ...
     * @return bool
     */
    public function removePackages(array $packages, bool $dev = false, \Closure|\Symfony\Component\Console\Output\OutputInterface|null $output = null, $composerBinary = null)
    {
        $command = collect([
            ...$this->findComposer($composerBinary),
            'remove',
